...
parser.add_argument('--k', type=int, default=0.5, help='k')
...
shape = adj.shape
cal_node = (shape[0] / args.clusters ) * 0.1
m = np.ceil(cal_node).astype(int)
features1, adj1 = get_center_1(features,args.clusters,adj,args.k, m, args.device)  
